            ...
            <ContentWrapper>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-white opacity-75 text-sm space-y-3 md:space-y-0 z-50">
                    ...
                    <div className="flex space-x-5 text-lg z-50">
                        <a href="https://www.facebook.com/dhrora26" target="_blank" rel="noreferrer"><span className="w-10 h-10 bg-black rounded-full flex items-center justify-center cursor-pointer border-black hover:text-orange hover:border-orange border duration-200"><FaFacebookF /></span></a>
